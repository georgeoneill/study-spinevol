...
%and draw:
if infflag
hp = patch('faces',mesh.e,'vertices',mesh.pinf,'facecolor',deffacecolor,'edgecolor',defedgecolor,...,
    'facealpha',deffacealpha,'edgealpha',defedgealpha);
else
    hp = patch('faces',mesh.e,'vertices',mesh.p,'facecolor',deffacecolor,'edgecolor',defedgecolor,...,
    'facealpha',deffacealpha,'edgealpha',defedgealpha);
end
%set options:
if ~isempty(plotopt)
