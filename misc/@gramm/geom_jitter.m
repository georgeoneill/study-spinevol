...
hndl=line(draw_data.x,draw_data.y,'LineStyle','none','Marker',draw_data.marker,'MarkerEdgeColor',draw_data.color,'markerSize',draw_data.point_size,'MarkerFaceColor',draw_data.color,'Linewidth',params.edgewidth);
