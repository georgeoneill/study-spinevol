...
hndl=patch(xpatch,...
    ypatch,...
    [1 1 1],'FaceColor',draw_data.color,'EdgeColor',params.color,'FaceAlpha',params.alpha,'EdgeAlpha',1,'LineWidth',params.linewidth);

%    [1 1 1],'FaceColor',draw_data.color,'EdgeColor',draw_data.color,'FaceAlpha',params.alpha,'EdgeAlpha',1,'LineWidth',params.linewidth);
