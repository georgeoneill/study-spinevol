function obj=geom_jitter_categorical(obj,varargin)
...
my_addParameter(p,'edgecolor',[0 0 0]);
my_addParameter(p,'edgewidth',1);
parse(p,varargin{:});
...
hndl=line(draw_data.x,draw_data.y,'LineStyle','none','Marker',draw_data.marker,'MarkerEdgeColor',params.edgecolor,'markerSize',draw_data.point_size,'MarkerFaceColor',draw_data.color,'Linewidth',params.edgewidth);
